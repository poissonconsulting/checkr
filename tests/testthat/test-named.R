...
test_that("named", {
  ...
  vec <- c(y = 1, yy = 2)
  expect_error(check_named(vec, nchar = 1), "elements of names of vec must have 1 character")
  expect_error(check_named(vec, nchar = c(2,4)), "elements of names of vec must have at least 2 characters")

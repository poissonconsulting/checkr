...
Perhaps the most interesting feature of `checkr` is the use of objects to check 
the values of other objects.
The expressive yet elegant syntax that makes this possible is described below.

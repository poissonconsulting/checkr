...
In short the `checkr` package is recommended over the alternatives if you are looking for a set of expressive, light-weight, pipe-friendly assertive functions with customisable object names.
